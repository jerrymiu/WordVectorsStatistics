...
with tf.Session(graph=graph) as session:
  ...
  for step in xrange(num_steps):
    ...
    if step % 2000 == 0:
      ...
      print('Training', int((step/num_steps)*100),'%')
      print()
      average_loss = 0
...
print('Training 100%')
print('Training completed, result graph visible at tsne.png and output.txt')
